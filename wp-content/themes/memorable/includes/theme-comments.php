	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container">
	            ...
	            <?php } ?>
		      	...
		      	<div class="comment-head">
	                ...
	                <span class="reply">&bull; <?php comment_reply_link( array_merge( $args, array( 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?></span>
	                <span class="edit"><?php edit_comment_link(__( 'Edit', 'woothemes' ), '&bull; ', '' ); ?></span>
