    ...
    <div id="content" class="col-full">
        ...
        <?php
            ...
            if ( 'true' == $settings['business_display_features'] ) {
                do_action( 'woothemes_features', array( 'before' => '<div class="widget widget_woothemes_features business">', 'after' => '</div>', 'per_row' => 4, 'limit' => 4 ) );
            }
            // Display Features if activated and specified in theme options
            if ( 'true' == $settings['business_display_testimonials'] ) {
                do_action( 'woothemes_testimonials', array( 'before' => '<div class="widget widget_woothemes_testimonials business">', 'after' => '</div>', 'per_row' => 4, 'limit' => 4 ) );
            }
        ?>
