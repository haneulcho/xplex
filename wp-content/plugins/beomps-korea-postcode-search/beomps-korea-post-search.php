<?php
	...
	function bkps_custom_override_checkout_fields( $fields ) {
		...
		// 주석 처리된 unset 은 해당 필드를 사용하지 않을 때 사용합니다. 
	     //unset($fields['billing']['billing_email']);
	      ...
	      $fields['billing']['billing_address_1']['label'] = '<input type="button" id="billing_postcode_search" class="button alt" value="우편번호 찾기" class="btn" onclick="openDaumPostcode();" style="margin-bottom:8px;">';

	      $fields['shipping']['shipping_address_1']['label'] = '<input type="button" id="shipping_postcode_search" class="button alt" value="우편번호 찾기" class="btn" onclick="openDaumPostcode2();" style="margin-bottom:8px;">';
	...
	function bkps_custom_override_billing_fields( $fields ) {
		...
		$fields['billing_address_1']['label'] = '<input type="button" id="billing_postcode_search" value="우편번호 찾기" class="button alt" onclick="openDaumPostcode();" style="margin-bottom:8px;">';
  	 	return $fields;
	}
	 ...
	 // add Administrator page	
  	 add_action('admin_menu', 'register_beomps_menu_page');
