	...
	function kcp_AJAX()
	{
        ...
        if( typeof gnupay_kcp_object.kcp_approval_url === "undefined" || !gnupay_kcp_object.kcp_approval_url ){
            alert('Send sendRequest URL not exists!');
            return false;
        }

		var url    = gnupay_kcp_object.kcp_approval_url;
		var form = document.gnupay_kcp_form;
