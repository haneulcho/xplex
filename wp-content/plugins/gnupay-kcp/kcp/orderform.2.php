...
$config['de_admin_company_name'] = get_bloginfo('name');

GNUPAY_KCP()->config = $config;
...
add_action( 'wp_footer', 'gnupay_kcp_orderform_hidden', 1 );
if( !function_exists('gnupay_kcp_orderform_hidden') ){
function gnupay_kcp_orderform_hidden(){

    $config = GNUPAY_KCP()->config;
    extract(GNUPAY_KCP()->goodsinfo);
?>
    <div style="display:none">
    <form name="gnupay_kcp_form" id="gnupay_kcp_form" method="POST" accept-charset="UTF-8">
    ...
    ?>
        ...
        <input type="hidden" name="is_test" value="<?php echo $config['de_card_test']; ?>" >
    <?php
        /*
