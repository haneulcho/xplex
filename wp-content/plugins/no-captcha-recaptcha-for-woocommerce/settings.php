...
class WC_Ncr_Settings_Page {
	...
	public static function settings_page() {
		...
		<h2>No CAPTCHA reCAPTCHA for WooCommerce</h2>

		<p>Protect WooCommerce login and registration form againt spam using Google's No CAPTCHA reCAPTCHA.</p>
		...
		<div class="meta-box-sortables ui-sortable">
			...
			<form method="post">
				...
				<div class="postbox">
					...
					<h3 class="hndle"><span><?php _e( 'reCAPTCHA Keys', 'wc-no-captcha' ); ?></span></h3>
				...
				<div class="postbox">
					...
					<div title="Click to toggle" class="handlediv"><br></div>
					<h3 class="hndle"><span><?php _e( 'Display Settings', 'wc-no-captcha' ); ?></span></h3>

					<div class="inside">
						<table class="form-table">
							<tr>
								<th scope="row"><label for="login"><?php _e( 'Login Form', 'wc-no-captcha' ); ?></label>
								</th>
								<td>
									...
									<p class="description">
										<?php _e( 'Check to enable CAPTCHA in login form', 'wc-no-captcha' ); ?>
							...
							<tr>
								...
								<td>
									...
									<p class="description">
										<?php _e( 'Check to enable CAPTCHA in WordPress registration form', 'wc-no-captcha' ); ?>
									</p>
								</td>
							</tr>
						</table>
				...
				<div class="postbox">
					...
					<div class="inside">
						<table class="form-table">
							<tr>
								<th scope="row"><label
										for="theme"><?php _e( 'Theme', 'wc-no-captcha' ); ?></label></th>
								<td>
